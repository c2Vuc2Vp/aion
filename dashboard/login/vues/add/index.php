  ...
  <div class="card">
      ...
      <form class="form-horizontal" id="form-horizontal" enctype='multipart/form-data'>
        ...
        <div class="row form-group">
          ...
          <div class="col col-md-3">
            ...
            <label for="text-input" class=" form-control-label">Pays de l'article</label>
          ...
          <div class="col-12 ml-auto col-md-6">
            ...
            <small class="form-text text-muted">Pays où il sera vendu</small>
        ...
        <div class="row form-group">
          ...
          <div class="col-12 ml-auto col-md-6">
            ...
            <input type="number" id="stock" name="stock" min="1" value="1" class="form-control" onkeypress="isInputNumber(event);" required="">
    ...
    <script>
      ...
      var dropzone = $("#dropzone").dropzone({
        ...
        successmultiple: function (file, response) {
          ...
          $('#form-horizontal')[0].reset();
            ...
            if (response == 'deplacement') {

              Swal.fire({

                position: 'top-end',
                title: 'Insertion',
                text: "Le fichier n'a pas pu être déplacé avec success.",
                type: 'error',
                showConfirmButton: false,
                timer: 5000
            ...
            if (response == 'vide') {
              ...
              Swal.fire({
                ...
                position: 'top-end',
                title: 'Insertion',
                text: "Veillez remplir tous les champs obligatoirement!",
                type: 'warning',
                showConfirmButton: false,
                timer: 5000
            ...
            if (response == 'volumineux') {

              Swal.fire({

                position: 'top-end',
                title: 'Insertion',
                text: "Votre fichier est trop volumineux!",
                type: 'warning',
                showConfirmButton: false,
                timer: 5000
            ...
            if (response == 'type') {
              ...
              Swal.fire({
                ...
                position: 'top-end',
                title: 'Insertion',
                text: "Vos images postées sont corrompues!",
                type: 'warning',
                showConfirmButton: false,
                timer: 5000
            ...
            if (response == 'erreur') {
              ...
              Swal.fire({
                ...
                position: 'top-end',
                title: 'Insertion',
                text: "Une erreur est subvenue, Veillez contacter le service client.",
                type: 'error',
                showConfirmButton: false,
                timer: 5000
      ...
      $(document).ready(function() {
        ...
        // Selection du pays où vendre le produit
